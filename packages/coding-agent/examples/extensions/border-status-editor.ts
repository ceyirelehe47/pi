import { CustomEditor, type ExtensionAPI, type ExtensionContext, type KeybindingsManager } from "@iris/pi-coding-agent";
import type { Component, EditorTheme, TUI } from "@iris/pi-tui";
import { truncateToWidth, visibleWidth } from "@iris/pi-tui";
