import type { AuthInfoLink, OAuthDeviceCodeInfo } from "@iris/pi-ai";
import { Container, type Focusable, getKeybindings, Input, Spacer, Text, type TUI } from "@iris/pi-tui";
