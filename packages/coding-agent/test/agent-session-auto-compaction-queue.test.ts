...
import { type AssistantMessage, createAssistantMessageEventStream, fauxAssistantMessage } from "@iris/pi-ai";
import { getModel, streamSimple } from "@iris/pi-ai/compat";
