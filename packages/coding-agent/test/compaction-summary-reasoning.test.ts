...
import type { AssistantMessage, Model } from "@iris/pi-ai";
...
vi.mock("@iris/pi-ai/compat", async (importOriginal) => {
	const actual = await importOriginal<typeof import("@iris/pi-ai/compat")>();
	return {
		...actual,
