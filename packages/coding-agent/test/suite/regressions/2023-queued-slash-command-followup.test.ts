import type { AgentTool } from "@iris/pi-agent-core";
import { fauxAssistantMessage, fauxToolCall } from "@iris/pi-ai";
import type { ExtensionAPI } from "@iris/pi-coding-agent";
